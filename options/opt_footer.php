...
Redux::setSection( 'saasland_opt', array(
	'title'     => esc_html__( 'Footer Settings', 'saasland' ),
	'id'        => 'saasland_footer',
...
Redux::setSection( 'saasland_opt', array(
    ...
    'fields'    => array(
        ...
        array(
            'title'     => esc_html__( 'Left Content', 'mukiragiton.ga' ),
            'id'        => 'copyright_txt',
            'type'      => 'editor',
            'default'   => '© 2020 <a href="https://mukiragiton.ga/">mukiragiton.ga</a>. All rights reserved',
            'args'    => array(
                'wpautop'       => true,
                'media_buttons' => false,
                'textarea_rows' => 10,
