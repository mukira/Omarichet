...
$copyright_text = !empty($opt['copyright_txt']) ? $opt['copyright_txt'] : esc_html__( '© 2020 http://mukiragiton.ga/. All rights reserved', 'mukiragiton.ga' );
                        ...
                        <div class="container">
                            <div class="row align-items-center">
                                <div class="col-lg-6 col-sm-7">
                                    <p>© mukiragiton.ga.. 2020 All rights reserved.</p>
                                </div>
                                <div class="col-lg-6 col-sm-5 text-right">
                                    <p>Made with ❤️ in <a href="https://mukiragiton.ga/">Nairobi</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
